        ...
        implements List<E>, RandomAccess, Cloneable, java.io.Serializable
{
     ...
     */
	 //构造一个包含指定元素的list，这些元素是按照Collection迭代器返回的顺序排列的
     ...
     * @throws IndexOutOfBoundsException {@inheritDoc}
     */
	 //插入指定的元素到该list指定的位置。移动当前位置的元素（如果有的话），并且后续元素向右移动（她们的索引数加一）
     ...
     */
	 //移除指定的元素，如果不存在list不改变，更确切的讲，她只是移除该元素在她第一次出现的位置
    ...
    public boolean addAll(int index, Collection<? extends E> c) {
        ...
        int numMoved = size - index;//需要移动的长度
        if (numMoved > 0)
